...
prompt -$g
title  UPUPW APACHE PHP7.0系列正式版
color 0A
mode con cols=80 lines=29 >nul 2>nul
goto menu
...
cls
echo.
echo     ╔════════ UPUPW APACHE版PHP7.0系列正式版1512.1 ═══════╗
echo     ║                                                                    ║
echo     ║                                                                    ║
...
echo   正常开启%apache_port%端口被Apache占用，%database_port%端口被MySQL/MariaDB占用
echo   --------------------------------------------------------------------------
